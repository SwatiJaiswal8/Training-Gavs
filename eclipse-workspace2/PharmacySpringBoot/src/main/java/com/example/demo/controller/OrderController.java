...
public class OrderController {
    ...
    public String updateOrder(@PathVariable Long id, @RequestBody Order updatedOrder) throws OrderNotFoundException {
    ...
    public String removeMedicineFromOrder(@PathVariable Long orderId, @PathVariable Long medicineId) throws OrderNotFoundException, MedicineNotFoundException {
        orderService.removeMedicineFromOrder(orderId, medicineId);
        return "medicine is removed from order";
    }
